...
function createTheme(defaultGetTokens) {
    ...
    function Consumer(props) {
        ...
        return (react_1.default.createElement(ThemeContext.Consumer, null, function (theme) {
    ...
    */
    function Provider(props) {
        return (react_1.default.createElement(ThemeContext.Consumer, null, function (themeFn) {
